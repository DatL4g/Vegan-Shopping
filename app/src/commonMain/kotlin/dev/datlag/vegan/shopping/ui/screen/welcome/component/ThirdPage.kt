...
fun ThirdPage(modifier: Modifier) {
    Column(
        ...
        Image(
            ...
            contentDescription = stringResource(SharedRes.strings.welcome_third),
        ...
        Text(
            text = buildAnnotatedString {
                append(stringResource(SharedRes.strings.welcome_third_text_part_1).trim())
                appendLine()
                appendLine()
                append(stringResource(SharedRes.strings.welcome_third_text_part_2).trim())
            },
